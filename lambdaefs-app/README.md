...
```bash
lambdaefs-app$ sam logs -n HelloEfsFunction --stack-name "lambdaefs-app" --tail
```
...
```bash
lambdaefs-app$ pip install -r tests/requirements.txt --user
# unit test
lambdaefs-app$ python -m pytest tests/unit -v
# integration test, requiring deploying the stack first.
# Create the env variable AWS_SAM_STACK_NAME with the name of the stack we are testing
lambdaefs-app$ AWS_SAM_STACK_NAME="lambdaefs-app" python -m pytest tests/integration -v
```
...
```bash
sam delete --stack-name "lambdaefs-app"
```
